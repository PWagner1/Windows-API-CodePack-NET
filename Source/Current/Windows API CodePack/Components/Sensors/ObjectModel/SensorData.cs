...
public class SensorData : IDictionary<Guid, IList<object>>
{
    ...
    /// <summary>
    /// Determines if a particular data field identifier is present in the collection.
    /// </summary>
    /// <param name="key">The data field identifier.</param>
    ...
    {
        if (_sensorDataDictionary.TryGetValue(key, out var nullableList))
        {
            // Cast IList<object?> to IList<object> safely
            value = nullableList.Cast<object>().ToList();
            return true;
        }
        value = null!;
        return false;
    ...
    public IEnumerator<KeyValuePair<Guid, IList<object>>> GetEnumerator() => _sensorDataDictionary.GetEnumerator();
    ...
    /// </summary>
    /// <returns>An enumerator.</returns>
    System.Collections.IEnumerator System.Collections.IEnumerable.GetEnumerator() => _sensorDataDictionary.GetEnumerator();
    #endregion
