...
namespace Microsoft.WindowsAPICodePack.Shell.PropertySystem
{
    ...
    public partial class ShellProperties
    {
        ...
        public class PropertySystem : PropertyStoreItems
        {
            ...
            public ShellProperty<UInt16?>? FlagColor
            {
                get
                {
                    ...
                    if (!_hashTable.ContainsKey(key))
                    {
                        _hashTable.Add(key, _shellObjectParent?.Properties?.CreateTypedProperty<UInt16?>(key));
                    }

                    return _hashTable[key] as ShellProperty<UInt16?>;
                }
            }
        ...
        public class PropertySystemDevices : PropertyStoreItems
        {
            ...
            /// <para>Description: bool value representing if the device is currently charging.
            ///</para>
            /// <para>Type:     Byte -- VT_UI1</para>
        ...
        public class PropertySystemImage : PropertyStoreItems
        {
            ...
            public ShellProperty<Int16?>? ResolutionUnit
            {
                get
                {
                    ...
                    if (!_hashTable.ContainsKey(key))
                    {
                        _hashTable.Add(key, _shellObjectParent?.Properties?.CreateTypedProperty<Int16?>(key));
                    }

                    return _hashTable[key] as ShellProperty<Int16?>;
                }
            }
