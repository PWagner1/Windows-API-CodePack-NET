        ...
        Private Sub LoadNetworkConnections()
            ...
            For Each n As Network In networks
                ...
                For Each nc As NetworkConnection In connections
                    s.AppendFormat(vbLf + vbTab & "Connection ID: {0}" & vbLf + vbTab & "Domain: {1}" & vbLf + vbTab & "Is connected: {2}" & vbLf + vbTab & "Is connected to internet: {3}" & vbLf, nc.ConnectionId, nc.DomainType, nc.IsConnected, nc.IsConnectedToInternet)
                    s.AppendFormat(vbTab & "Adapter ID: {0}" & vbLf + vbTab & "Connectivity: {1}" & vbLf, nc.AdapterId, nc.Connectivity)
                Next nc
                s.AppendLine()
